...
void ai_route(const char* input) {
    ...
    static const char* about_words[] = {"aurora", "about", "ueber", "uber"};
    ...
    switch (category) {
        ...
        case 7: {
            ...
            console_write("[ai] AuroraFS ist aktiv. Aktueller Ort: ");
        ...
        case 8:
            ...
            return;
        case 9:
            console_writeln("[ai] Hallo. AuroraOS ist bereit.");
            return;
        case 10:
        ...
        case 15:
            ...
            return;
        case 16:
            console_writeln("[ai] AuroraOS will einfach, modular und zweisprachig sein.");
        ...
        case 19:
            print_app_overview();
            console_writeln("[ai] Tipp: Nutze 'app list', 'app info lumen' oder 'app install browser'.");
            return;
        case 20:
    ...
    console_writeln("[ai] Noch nicht ganz klar erkannt.");
    console_writeln("[ai] Versuche: help, status, diag, app list, nic, netup, network, cp, mv, find, cmd new hallo, prog info hallo oder fs.");
}
